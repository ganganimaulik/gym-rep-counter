...
describe('WorkoutPicker', () => {
  ...
  it('renders "Select a workout..." when no workout selected', () => {
    const { getByText } = render(
      <WorkoutPicker selectedValue={null} onValueChange={mockOnValueChange} workouts={mockWorkouts as any} />
    );
  ...
  it('renders selected workout name', () => {
    const { getByText } = render(
      <WorkoutPicker selectedValue="w1" onValueChange={mockOnValueChange} workouts={mockWorkouts as any} />
    );
