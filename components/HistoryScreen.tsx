    ...
    return (
      ...
      >
        ...
        <StyledText className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider mt-2">
          {item.date.toDate().toLocaleTimeString(undefined, { hour: '2-digit', minute: '2-digit' })}
        </StyledText>
      </StyledTouchableOpacity>
    );
  };
    ...
    <StyledView className="flex-1 bg-zinc-950 p-4">
      ...
      >
        <KeyboardAvoidingView
          ...
          style={{ flex: 1 }}
        >
          <StyledBlurView intensity={25} tint="dark" className="flex-1 justify-center items-center px-4 bg-black/40">
            <StyledView className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl w-full max-w-sm shadow-2xl">
              ...
              />
              <StyledText className="text-zinc-400 text-xs font-bold mb-1.5 uppercase tracking-wide">Weight (kg)</StyledText>
              <StyledTextInput
                className="bg-zinc-950 border border-zinc-800 text-white p-3 rounded-xl mb-4 font-bold text-sm"
                keyboardType="number-pad"
                value={editWeight}
              ...
              >
                ...
                <StyledText className="text-red-500 font-bold text-xs ml-2 uppercase tracking-wider">Delete Entry</StyledText>
              </StyledTouchableOpacity>
            </StyledView>
          </StyledBlurView>
        </KeyboardAvoidingView>
